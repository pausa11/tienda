import "./App.css";                                                         //se importa el css para poder usarlo en la aplicacion
...
function App() {                                                            //se crea la funcion app                    
  return (                                                                  //se retorna la funcion app               
    <div className="App">                                                   
...
export default App;                                                         //se exporta la funcion app                    
